...
$this->title = Yii::t('app', 'Cálculo de Comisiones');
...
<?php echo Dialog::widget(); ?>
  ...
  <?= GridView::widget([
    ...
    'panel' => [
          'heading'=>'<h3 class="panel-title"><i class="fa fa-exclamation"></i> Cálculo de Comisiones</h3>',
          'type'=>'info',
        ...
        'columns' => [
                  ...
                  'buttons' => [
                    'update' => function ($url, $model, $key) {
                        return Html::a('<span class="btn btn-xs btn-primary"><i class="ace-icon fa fa-refresh bigger-120"></i></span> ',
                            Url::to(['comisiones/update','id'=>$model->id]), [
                      ...
                      'buttons' => [
                        'delete' => function ($url,$model, $key) {
                              ...
                              return Html::a('<span class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash bigger-120"></i></span> ', '#', [
                                  ...
                                  'onclick' => "
                                  krajeeDialog.confirm('Esta seguro de eliminar el Tipo de Documento:  ' +  '$model->ref', function (result) {
                                       if (result) {
                                          $.ajax({
            ...
            [
              ...
              'value'=>function($model){
                return $model->chof->getDatosHtml();
              },
              'format'=>'raw'
            ],
            'descripcion',
