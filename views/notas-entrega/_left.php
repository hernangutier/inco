...
/* @var $model common\models\NotasEntrega */
...
<span style="font-family: Arial, sans-serif; line-height: 19px; color: #777777; font-size: 14px;">Entrega de Mercancia por Nota de Entrega </span>
...
<a href="#" style="color: #428bca; text-decoration: none; background-color: transparent;"><?= $model->fecha  ?></a>
<hr data-skipstyle="true" style="border-width: 0px; height: 1px; background-color: #e8e8e8;">
...
<a href="#" style="color: #428bca; text-decoration: none; background-color: transparent;"><?= $model->motivo ?></a>
